...
export default async function handler(req) {
    // 🛡️ 设个简单的暗号，防止别人乱点你的链接疯狂注入数据
    const url = new URL(req.url);
    if (url.searchParams.get('pwd') !== 'hebao666') {
    ...
    try {
        ...
        const seedData = [
            ...
            { dutch_name: "Drop", chinese_name: "荷兰甘草糖", category: "零食", is_recommended: 0, insight: "纯纯大冤种，买来整蛊室友必备。", pairing: "🧑‍🍳 网友点评 [💣 避雷]：\n超市结账时顺手拿了一包，回宿舍吃第一口以为自己嚼了一块泡过八角大料的废旧汽车轮胎。当场吐了，千万别碰！", warning: "极度危险，吃一口想退学。", alternatives: "Haribo正常小熊软糖", features: "暗黑料理 | 轮胎味", image_url: "https://images.unsplash.com/photo-1582058091505-f87a2e55a40f?w=600&auto=format&fit=crop", likes: 5, dislikes: 298 },
            { dutch_name: "Karnemelk", chinese_name: "脱脂酪乳 (假酸奶/牛奶)", category: "饮品", is_recommended: 0, insight: "不要看它长得像牛奶，那是馊水！", pairing: "🧑‍🍳 网友点评 [💣 避雷]：\n刚来荷兰不懂荷兰语，以为是全脂牛奶买回去大喝一口，酸倒牙了！味道就像是在常温下放了三天馊掉的洗碗水。", warning: "认准包装上的'Karnemelk'，看到快跑。", alternatives: "Volle Melk (全脂牛奶) 或 Yoghurt (正常酸奶)", features: "新手杀手 | 极致酸爽", image_url: "https://images.unsplash.com/photo-1563636619-e9143da7973b?w=600&auto=format&fit=crop", likes: 2, dislikes: 215 },
            { dutch_name: "Verse Pesto", chinese_name: "冷鲜区青酱", category: "调料/酱料", is_recommended: 1, insight: "别买玻璃瓶装的，买冷鲜区的，味道天差地别！", pairing: "🧑‍🍳 网友点评 [👍 推荐]：\n【极简步骤】\n1. 煮一把意面捞出。\n2. 直接挖两勺这个新鲜青酱拌匀。\n3. 撒点小番茄，三分钟搞定一顿米其林级别的糊弄学午餐！", warning: "保质期很短，开盖后几天内吃完。", alternatives: "本赛道无敌，千万别买常温货架的罐装青酱。", features: "有手就行 | 意面灵魂", image_url: "https://images.unsplash.com/photo-1596796960163-f018e7c2e365?w=600&auto=format&fit=crop", likes: 142, dislikes: 1 },
            { dutch_name: "Kibbeling", chinese_name: "荷兰炸鱼块", category: "熟食/海鲜", is_recommended: 1, insight: "荷兰少有的符合中国胃的神仙小吃！", pairing: "🧑‍🍳 网友点评 [👍 推荐]：\n外酥里嫩，超市鱼摊或者外面早市都有卖。买的时候一定要跟老板说加蒜蓉酱（Knoflooksaus）！趁热吃，一口一个停不下来。", warning: "买超市冷藏的回家用空气炸锅复热，微波炉热会软趴趴。", alternatives: "Lekkerbekje (整条炸鱼，但有刺)", features: "国民小吃 | 外酥里嫩", image_url: "https://images.unsplash.com/photo-1599084942896-67b1bf0525d8?w=600&auto=format&fit=crop", likes: 201, dislikes: 4 },
        ...
        const requests = seedData.map(item => ({
            ...
            stmt: {
                ...
                args: [
                    ...
                    { type: "integer", value: String(item.likes) }, { type: "integer", value: String(item.dislikes) }
                ]
            }
        }));
