...
const tipsData = [
    {
        ...
        stores: [
            ...
            },
            {
                ...
                tips: [
                    { title: "✨ 新鲜度霸王条款", desc: "如果你在货架上发现了**今天到期 (Vandaag Datum)** 的商品，不要犹豫直接拿给店员，他们会按规矩免费换一个同款新鲜的给你！" },
                    { title: "🚶 排队免单条款", desc: "如果你结账排队排在第 4 个，且其他收银台没开，大喊店员，你这一整车的东西**直接全额免单**（仅限非自助收银台）。" },
                    { title: "💳 Extra's 积分换大件", desc: "结账必扫码，积分千万别花在买杯子上。攒够积分直接在 App 里兑换**免费洗衣液、卫生纸**，或者一大盒高档冷鲜鱼。" }
                ]
            },
            {
                storeLogo: "🛒",
